                ...
                <div class="col-md-9">
                    <div class="image-sub ">
                        ...
                        <div class="preview" ref="preview" @mousedown="startDragRotate" @mousemove="dragRotateProduct"
                            ...
                            <img src="../assets/neck.png" alt="Uploaded Image" style="width: 100%; height: 100vh;">
...
<script>
import jew1 from '@/assets/categories/jewelleryimg/jew1.png';
import jew2 from '@/assets/categories/jewelleryimg/jew2.jpg';
export default {
    name: 'JewelleryView',
    data() {
        return {
            ...
            products: [
                { name: 'Product 1', image: jew1, width: 140, height: 140, depth: 0, top: 300, left: 300, rotationX: 0, rotationY: 0, rotationZ: 0, scale: 1 },
                { name: 'Product 2', image: jew1, width: 120, height: 120, depth: 0, top: 250, left: 250, rotationX: 0, rotationY: 0, rotationZ: 0, scale: 1 },
                { name: 'Product 3', image: jew2, width: 140, height: 140, depth: 0, top: 300, left: 300, rotationX: 0, rotationY: 0, rotationZ: 0, scale: 1 }
            ],
            selectedProduct: '',
            selectedProducts: [],
            dragRotating: false,
